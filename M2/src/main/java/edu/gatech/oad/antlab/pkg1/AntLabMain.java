...
public class AntLabMain {
	...
	public void printOutMessage() {
		...
		Person1 p1 = new Person1("JONGWOO JANG:");
		toPrint += p1.toString("jjang74");
		// Person2 replace P2 with your name
		// and gburdell with your gt id
		Person2 p2 = new Person2("//YEAWON YOON:");
		toPrint += p2.toString("yyoon75");
		// Person3 replace P3 with your name
		// and gburdell3 with your gt id
		Person3 p3 = new Person3("//IKTAE KIM:");
		toPrint += p3.toString("ikim75");
		// Person4 replace P4 with your name
		// and gburdell4 with your gt id
		Person4 p4 = new Person4("//GYUNGYOON YOO:");
		toPrint += p4.toString("gyoo7");
		// Person5 replace P4 with your name
		// and gburdell5 with your gt id
		Person5 p5 = new Person5("//TAEYEONG KIM:");
		toPrint += p5.toString("tkim381");
